...
> = {
  zh: {
    ...
    chartDataMappingIntro: '先选分类列，再添加一列或多列数值。',
    ...
    chartSelectColumnsHint: '选择分类列并添加至少一个数值列',
    chartRemove: '移除',
    ...
    settingsEdgeWidth: '张量线粗细',
    settingsEdgeCurvature: '张量线弧度',
    settingsNodeCornerRadius: '算子圆角',
    settingsNodeStrokeWidth: '算子框粗细',
    settingsGraphHeatStrokeWidthMultiplier: '热分析线条宽度倍率',
    settingsNodeTextColor: '算子文字',
    settingsEdgeLabelShape: '张量形状',
    settingsNodeLabelAttrs: '算子属性',
    ...
    dataPanelYAxis: '数值',
    dataPanelYAxisWithIndex: '数值 {index}',
    dataPanelAlias: '别名',
    // Style options
    styleSolid: '实线',
    styleGradient: '渐变',
    ...
    settingsNodeSize: '算子尺寸',
    settingsNodeGap: '算子间距',
    settingsRankGap: '层级间距',
    settingsLang: '语言',
    settingsLangZh: '中文',
    settingsLangEn: 'English',
    settingsAbout: '关于',
    settingsAboutLicense: 'GPL-3.0',
    settingsGeneral: '常规',
    settingsColors: '色彩',
    settingsColorUi: '界面',
    ...
    colorNodeFill: '算子填充',
    colorNodeStroke: '算子描边',
    colorNodeTextColor: '算子文字',
    colorNodeAttrFill: '算子属性背景',
  ...
  en: {
    ...
    chartDataMappingIntro: 'Select category column, then add one or more value columns.',
    ...
    chartSelectColumnsHint: 'Select category column and add at least one value column',
    chartRemove: 'Remove',
    ...
    settingsEdgeWidth: 'Tensor line width',
    settingsEdgeCurvature: 'Tensor line curvature',
    settingsNodeCornerRadius: 'Operator corner radius',
    settingsNodeStrokeWidth: 'Operator stroke',
    settingsGraphHeatStrokeWidthMultiplier: 'Heat analysis stroke width multiplier',
    settingsNodeTextColor: 'Operator text',
    settingsEdgeLabelShape: 'Tensor shape',
    settingsNodeLabelAttrs: 'Operator attributes',
    ...
    dataPanelYAxis: 'Value',
    dataPanelYAxisWithIndex: 'Value {index}',
    ...
    settingsNodeSize: 'Operator size',
    settingsNodeGap: 'Operator gap',
    ...
    colorNodeFill: 'Operator fill',
    colorNodeStroke: 'Operator stroke',
    colorNodeTextColor: 'Operator text',
    colorNodeAttrFill: 'Operator attrs background',
    colorTensorFill: 'Tensor fill',
    colorTensorStroke: 'Tensor stroke',
    colorEdgeStroke: 'Tensor line',
